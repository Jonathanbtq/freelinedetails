...
/**
 * \file    core/triggers/interface_99_modFreelinedetails_FreelinedetailsTriggers.class.php
 ...
 *      - interface_99_modFreelinedetails_MyTrigger.class.php
...
/**
 *  Class of triggers for Freelinedetails module
 */
class InterfaceFreelinedetailsTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Freelinedetails triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'freelinedetails@freelinedetails';
	}
